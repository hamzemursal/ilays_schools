...
function setup() {
  const prisma: MockPrisma = {
    ...
    class: { findFirst: jest.fn().mockResolvedValue({ id: "class-1", name: "Form 1", academicYearId: "year-1" }) },
    subject: { findFirst: jest.fn().mockResolvedValue({ id: "subject-1" }) },
    exam: { findFirst: jest.fn().mockResolvedValue({ id: "exam-1", schoolId: SCHOOL_ID, academicYearId: "year-1" }), create: jest.fn(), findUniqueOrThrow: jest.fn() },
