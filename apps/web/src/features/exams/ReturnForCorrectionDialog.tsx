...
const COMMON_REASONS = [
  "One or more marks appear incorrect",
  "Marks exceed the maximum allowed",
  "Missing marks for some students",
  "Wrong exam paper attached",
  "Other",
];

// A reason is always required — ExamsService.returnForCorrection rejects
// the request outright without one — same shape as RejectTransferDialog.
      ...
      >
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0">
            <h2 className="font-semibold text-foreground">Return for Correction?</h2>
            <p className="mt-1 text-sm text-foreground-soft">The teacher will be able to edit and resubmit. A reason is required.</p>
          </div>
        </div>
        ...
        <div className="mt-4 space-y-3">
          ...
          {preset === "Other" && (
            <Textarea
              ...
              placeholder="e.g. Student STU-003 mark appears incorrect."
              rows={3}
              autoFocus
            />
          )}
