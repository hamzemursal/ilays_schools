  ...
  return (
    <Card>
      ...
      <p className="mt-1 text-sm text-foreground-soft">
        ...
        sectionName. Every row is checked for a possible duplicate by matching name + date of birth against existing
        students. Optional: studentNumber, rollNumber, legacyStudentNumber (a prior/external student ID — also
        checked as an extra duplicate signal if provided), and a single guardian per row (guardianFirstName,
