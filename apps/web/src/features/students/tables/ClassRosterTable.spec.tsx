...
function renderTable(overrides: Partial<React.ComponentProps<typeof ClassRosterTable>> = {}) {
  return render(
    <ToastProvider>
      <ClassRosterTable
        schoolId="school-1"
...
describe("ClassRosterTable — loading/empty states", () => {
...
describe("ClassRosterTable — real data rendering", () => {
...
describe("ClassRosterTable — attendance column", () => {
...
describe("ClassRosterTable — optional columns", () => {
...
describe("ClassRosterTable — navigation", () => {
...
describe("ClassRosterTable — row actions menu", () => {
...
describe("ClassRosterTable — search", () => {
...
describe("ClassRosterTable — selection", () => {
